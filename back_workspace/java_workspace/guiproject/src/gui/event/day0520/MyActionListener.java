...
public class MyActionListener implements ActionListener{
	...
	//메서드를 통해 다른클래스에 존재하던 버튼들을 전달받음 (생성자 주입==injection)
	...
	//해당 이벤트 정보를 알맞는 이벤트 객체로 인스턴스화 시킴 
	//그리고 생성된 이벤트 인스턴스는, 재정의 메서드인 actionPerformed()
	//메서드로 전달해준다..개발자는 자신이 알고싶은 이벤트 정보를 ActionEvent
	//로 부터 모든것을 알아낼 수 있다..
	//js 에서의  addEventListner("click", (e)=>{}); e 와 동일
	public void actionPerformed(ActionEvent e){
		//이벤트를 일으킨 주체를 가리켜 이벤트소스 event source
