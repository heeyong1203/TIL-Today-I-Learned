...
public class ShopMain extends JFrame implements ActionListener{
	...
	public ShopMain() {
		...
		bt_home.putClientProperty("id", HOME); // id=0
		bt_product.putClientProperty("id", PRODUCT); // id=1
		bt_myPage.putClientProperty("id", MYPAGE); // id=2
		bt_cs.putClientProperty("id", CS); // id=3
	...
	public void actionPerformed(ActionEvent e) {
		...
		JButton obj=(JButton)e.getSource(); // 버튼의 소스값을 가져와야 하므로 버튼으로 다운캐스팅
