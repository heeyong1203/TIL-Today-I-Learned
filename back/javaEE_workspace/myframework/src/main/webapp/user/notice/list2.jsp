<%@page import="com.sinse.myframework.staff.model.domain.Notice"%>
<%@page import="com.sinse.myframework.staff.model.repository.NoticeDAO"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
<%! 
	// list.jsp가 웹컨테이너에 의해, 서블릿으로 작성될 때의 멤버 영역 (선언부)
