	...
	<div class="container">
		<form action="/action_page.php">
			<div class="row">
				...
				<div class="col">
					<a href="javascript:login('naver')" class="naver btn"> <i class="fa fa-facebook fa-fw"></i>Login with Naver</a> 
					<a href="javascript:login('kakao')" class="kakao btn"> <i class="fa fa-twitter fa-fw"></i> Login with Kakao</a> 
					<a href="javascript:login('google')" class="google btn"><i class="fa fa-google fa-fw"></i> Login with Google+ </a>
				</div>
